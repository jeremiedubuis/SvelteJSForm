(function (global, factory) {
    ...
    (global = global || self, factory(global.Form = {}));
    ...
    /* src\FormField.svelte generated by Svelte v3.14.1 */

    const FormField = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    	const { className = "", id, label, type = "text", options, onBlur, onChange, onFocus, validation = {}, ...nativeProps } = $$props;
    	let error = null;
    	let value;
	...
	? `<textarea${spread([{ id: escape(id) }, nativeProps])}></textarea>`
	: `${typeLower === TYPES.SELECT
		? `<select${spread([{ id: escape(id) }, nativeProps])}>
            ${each(options, o => `<option${add_attribute("value", o.value, 0)}>${escape(o.label)}</option>`)}
        </select>`
		: `<input${spread([{ id: escape(id) }, { type: escape(typeLower) }, nativeProps])}>`}`}
